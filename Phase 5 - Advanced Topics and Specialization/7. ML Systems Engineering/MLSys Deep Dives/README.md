...
* Phase 5 — Edge AI — [Edge LLM Inference Internals](../../3.%20Edge%20AI/Edge%20LLM%20Inference%20Internals/Lecture-01.md) — the roofline, GEMV-vs-GEMM, and why decode is memory-bound. Every "Measure it" here assumes it.
