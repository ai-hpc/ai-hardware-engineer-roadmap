...
The [BFCL evaluation lecture](../../../3.%20Edge%20AI/Agent%20Tool-Dispatch%20Evaluation%20with%20BFCL/Lecture-01.md) framework applies to MoE inference exactly as to dense. At MoE FP4, tool-call accuracy is the parity gate that decides if FP4 ships.
...
* [Phase 5 → Edge AI → Agent Tool-Dispatch Evaluation with BFCL](../../../3.%20Edge%20AI/Agent%20Tool-Dispatch%20Evaluation%20with%20BFCL/Lecture-01.md)
...
* Up: [Phase 5 → 7. ML Systems Engineering](../../Guide.md)
