...
* [Phase 5 → Edge AI → Edge LLM Inference Internals](../../../Track%20C%20-%20Edge%20AI/Edge%20LLM%20Inference%20Internals/Lecture-01.md) — GEMV vs GEMM
* [Phase 5 → Edge AI → Qwen Inference Optimization → Lecture 03 — Decode Optimization on Jetson](../../../Track%20C%20-%20Edge%20AI/Qwen%20Inference%20Optimization/Lecture-03.md) — bandwidth-bound decode on the edge end
