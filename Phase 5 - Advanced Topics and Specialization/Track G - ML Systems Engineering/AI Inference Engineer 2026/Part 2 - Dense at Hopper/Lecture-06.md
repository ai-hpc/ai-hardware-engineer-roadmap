...
* [Phase 5 → GPU Infrastructure → Long-Context-MoE-Foundation-Training → 07 Long-Context Evaluation](../../../Track%20A%20-%20GPU%20Infrastructure/Nvidia%20GPU/HPC%20Setup/Long-Context-MoE-Foundation-Training/07-Long-Context-Evaluation.md)
...
* Next: [Lecture 07 — Inside the communication layer](Lecture-07.md) — NCCL, custom all-reduce, and the vLLM communicator stack
