...
* **Dedicated course:** [Qwen3.5-4B-Base Fine-Tuning with Unsloth](Qwen3.5-4B%20Unsloth%20Fine-Tuning/Guide.md) — 16-bit LoRA SFT, adapter export, evaluation, and hardware-cost reporting
